...
import Google from '../../assets/icons/Group 136188.png'
import MasterCard from '../../assets/icons/Group 136190.png'
import PayPal from '../../assets/icons/Group 136192.png'
import American from '../../assets/icons/Group 136193.png'
import Apple from '../../assets/icons/Group 136194.png'
import OPay from '../../assets/icons/Group 136195.png'
const Footer = () => {
    const paymentMethods = [
        { name: "Google Pay", src: Google },
        { name: "MasterCard", src: MasterCard },
        { name: "PayPal", src: PayPal },
        { name: "American Express", src: American },
        { name: "Apple Pay", src: Apple },
        { name: "O Pay", src: OPay },
    ];
